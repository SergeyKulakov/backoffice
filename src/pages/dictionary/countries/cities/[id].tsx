...
import { CitiesEditForm } from "../../../../sections/dictionaries/cities-edit-form";
...
function SinglePageCounrties() {
  ...
  const cityIdParam = Array.isArray(cityId) ? cityId[0] : cityId;
        ...
        <Container maxWidth="lg">
          <Stack spacing={4}>
            ...
            {isSuccess && countriesData ? (
              <Card>
                <CitiesEditForm data={countriesData} cityId={cityIdParam} />
              </Card>
            ) : (
